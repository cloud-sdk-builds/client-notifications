...
[`@aws-sdk/client-notifications`](https://www.npmjs.com/package/@aws-sdk/client-notifications/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-notifications@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k1yJAZkxAJNR4wsrHHeKgggXcC0ecj1NHDiKsDboslefzgtaGA5AVx3Pz7pvgKfc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-notifications": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-notifications@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-notifications@3.723.0/index.min.mjs": "sha384-k1yJAZkxAJNR4wsrHHeKgggXcC0ecj1NHDiKsDboslefzgtaGA5AVx3Pz7pvgKfc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-notifications/blob/refs/tags/3.723.0/LICENSE
```
