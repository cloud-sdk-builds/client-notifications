...
[`@aws-sdk/client-notifications`](https://www.npmjs.com/package/@aws-sdk/client-notifications/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-notifications@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LpvM+joWjB7hpsKnyvqngO+uth526vrBI2JsQahkh6vTRkpDmOwjy+kO1ziixY0S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-notifications": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-notifications@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-notifications@3.882.0/index.min.mjs": "sha384-LpvM+joWjB7hpsKnyvqngO+uth526vrBI2JsQahkh6vTRkpDmOwjy+kO1ziixY0S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-notifications/blob/refs/tags/3.882.0/LICENSE
```
